 ...
 async  update()
  {
   ...
   let transactionCoordinator = new TransactionCoordinator(this.mintingWeb3,this.paymentsWeb3,this.poolConfig,  this.mongoInterface  )

   transactionCoordinator.update();

    
   
    const tokenContract = await ContractHelper.getTokenContract( this.mintingWeb3 , this.poolConfig  )  
    ...
    cron.schedule('*/20 * * * * *', async function() {
      ...
      await TokenDataHelper.collectTokenParameters( tokenContract,  this.mintingWeb3,  this.mongoInterface) 
