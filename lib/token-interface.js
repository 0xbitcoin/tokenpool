 ...
 async  update()
  {
      ...
      //reply ok
   transactionCoordinator.init(this.web3,this.tokenContract,this.poolConfig,this.accountConfig,this.redisInterface,this.mongoInterface,this)
    ...
    for(i in minerList) //reward each miner
    {
      var minerAddress = minerList[i];
       ...
       if(miner_token_balance > min_balance_for_transfer)
       {
         ...
         await this.mongoInterface.upsertOne('balance_payment',{id: balancePaymentData.id} ,  balancePaymentData   )
