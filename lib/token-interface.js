...
module.exports =  {
 ...
 async  update()
  ...
  {
     var targetJSON = await this.redisInterface.loadRedisData('miningTarget');
  ...
  async collectTokenParameters( )
  {
    ...
    console.log('Challenge number:', challengeNumber)
      ...
      this.redisInterface.storeRedisData('miningTarget', JSON.stringify( miningTarget.toNumber() ) )
