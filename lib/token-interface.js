 ...
 async  update()
  {
   ...
   transactionCoordinator.init(this.web3,this.tokenContract,this.poolConfig,this.accountConfig,this.redisInterface,this)
    ...
    await self.collectTokenParameters();
     ...
     setTimeout(function(){ self.transferMinimumTokensToPayoutWallet()} , 10*1000)
...
//minerEthAddress
  ...
  {
    var txData= {
      addressFromType: addressFromType,
      addressTo:addressTo,
  ...
  */
  async transferMinimumTokensToPayoutWallet()
  {
    ...
    {
      minPayoutWalletBalance = 1000;
    }

    var payoutWalletAddress =  this.accountConfig.accounts.payment.address;
    var mintingWalletAddress =  this.accountConfig.accounts.minting.address;
