 ...
 async  update()
  {
      ...
      //reply ok
   transactionCoordinator.init(this.web3,this.pool_env, this.redisInterface,this.mongoInterface, this.web3apihelper )
   ...
   transactionCoordinator.update();
    ...
    await this.collectTokenParameters();
     ...
     setInterval(function(){ TokenInterface.collectTokenParameters(this.tokenContract, this.mongoInterface) }.bind(this),  COLLECT_TOKEN_DATA_PERIOD);

     //do one right away
     setTimeout(function(){ TokenInterface.collectTokenParameters(this.tokenContract, this.mongoInterface) }.bind(this),  1000);

    // setTimeout(function(){ self.transferMinimumTokensToPayoutWallet()} , 1000)


    setTimeout(function(){ TokenInterface.queueTokenTransfersForBalances(this.mongoInterface)}.bind(this) , 0)
...
//minerEthAddress
 ...
 static async queueTokenTransfersForBalances(mongoInterface )
  {
  ...
  var minerList =  await this.getMinerList()
    ...
    //drain their balance and send that many tokens to them
      ...
      setTimeout(function(){ this.queueTokenTransfersForBalances(mongoInterface)}.bind(this) , 20 * 1000)
