 ...
 async  update()
  {
      ...
      //reply ok
   transactionCoordinator.init(this.web3,this.tokenContract,this.mintHelperContract, this.poolConfig,this.accountConfig,this.redisInterface,this.mongoInterface,this,this.pool_env)
