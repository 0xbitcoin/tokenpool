...
export default class MongoInterface  {
    ...
    {
      await this.dbo.createIndexOnCollection('miner_shares', 'minerEthAddress') 
      await this.dbo.createIndexOnCollection('minerData', 'minerEthAddress') 
      await this.dbo.createIndexOnCollection('balance_payments', 'minerEthAddress') 
