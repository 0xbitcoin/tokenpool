...
module.exports =  {
  ...
  async init( https_enabled,mongoInterface   )
  {
          ...
          socket.on('ping', function (data) {
            console.log('ping', data);
             ...
             socket.on('getAllMinerData', async function (data) {
                 ...
                 var minerData = await PoolStatsHelper.getAllMinerData( this.mongoInterface )
                ...
                socket.on('getAllTransactionData', async function (data) {
                   ...
                   var txData = await PoolStatsHelper.getAllTransactionData( this.mongoInterface )
              ...
              socket.on('getPoolData', async function (data) {
                  ...
                  var poolData = await PoolStatsHelper.getPoolData( this.mongoInterface )
