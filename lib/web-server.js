...
module.exports =  {
  ...
  async init( https_enabled,webInterface,peerInterface,web3apihelper   )
  {
           ...
           socket.on('getUnconfirmedBroadcastedPaymentData', async function (data) {
            ...
            socket.on('getHashrateData', async function (data) {
             ...
             socket.on('getPoolConfig', async function (data) {
                 ...
                 poolData.poolConfig.solutionGasPriceWei = await self.web3apihelper.getGasPriceWeiForTxType('solution')
                 poolData.poolConfig.transferGasPriceWei = await self.web3apihelper.getGasPriceWeiForTxType('payment')
