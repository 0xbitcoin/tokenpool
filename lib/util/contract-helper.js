  ...
  getDoubleKingsRewardContract(web3,pool_env)
  {
    ...
    return contract;
       ...
       getDoubleKingsRewardContractAddress(pool_env)
       {
         if(pool_env == 'test')
         {
           return deployedContractInfo.networks.testnet.contracts.doubleKingsReward.blockchain_address;
         }else if(pool_env == 'staging'){
           return deployedContractInfo.networks.staging.contracts.doubleKingsReward.blockchain_address;
         }else if(pool_env == 'production'){
           return deployedContractInfo.networks.mainnet.contracts.doubleKingsReward.blockchain_address;
         }
         console.error('no pool env set', pool_env)
       },
       ...
       getMiningKingAddress(pool_env)
       {
         ...
         if(pool_env == 'test')
         {
           return deployedContractInfo.networks.testnet.contracts.miningking.blockchain_address;
         }else if(pool_env == 'staging'){
           return deployedContractInfo.networks.staging.contracts.miningking.blockchain_address;
         }else if(pool_env == 'production'){
           return deployedContractInfo.networks.mainnet.contracts.miningking.blockchain_address;
         }
         console.error('no pool env set', pool_env)
       }
