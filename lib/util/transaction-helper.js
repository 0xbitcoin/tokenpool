  ...
  try{
   ...
   /* const txOptions = {
    ...
    const txOptions = {
      ...
      maxFeePerGas: web3utils.toHex( web3utils.toWei( solutionGasPriceWei.toString() , 'gwei' ) ),
      maxPriorityFeePerGas: web3utils.toHex( web3utils.toWei( priorityGasPriceWei.toString() , 'gwei' ) ),
      value: 0,
      to: addressTo,
      data: txData,
      type: "0x02"
  ...
  static async submitBatchedPayment(txData, mongoInterface, poolConfig)
  {
   ...
   /* const txOptions = {
    ...
    const txOptions = {
      nonce: web3Utils.toHex(txCount),
      gasLimit: web3Utils.toHex(estimatedGasCost),
      maxFeePerGas: web3Utils.toHex( web3Utils.toWei( paymentsGasPriceWei.toString() , 'gwei' ) ),
      maxPriorityFeePerGas: web3Utils.toHex( web3Utils.toWei( priorityGasPriceWei , 'gwei' ) ),
      value: 0,
      to: addressTo,
      data: txData,
      type: "0x02"
