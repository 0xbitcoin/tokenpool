...
module.exports =  {
  ...
  init(web3,accountConfig,redisInterface,mongoInterface)
  {
    this.web3=web3;
    ...
    this.miningKingContract = new web3.eth.Contract(miningKingContractJSON.abi,this.getMiningKingAddress())

    this.mintHelperContract = new web3.eth.Contract(mintHelperContractJSON.abi,this.getMintHelperAddress())
