...
/*
  async init( web3, accountConfig, poolConfig , redisInterface , mongoInterface, pool_env  )
  {
   ...
   static async getAllMinerData(  mongoInterface)
    ...
    static async getPoolData(  mongoInterface)
    { 
    ...
    static async getMinerBalancePayments(minerAddress,limitAmount, mongoInterface)
    { 
      var payments = await mongoInterface.findAll('balance_payment',{minerAddress: minerAddress.toString().toLowerCase()})
