  ...
  async getAverageSolutionTime(minerAddress)
  {
   ...
   async cleanRedisData()
   {
     ...
     for(i in minerList) //reward each miner
     {
       ...
       await this.redisInterface.removeFromRedisListToLimit("miner_invalid_share:"+minerEthAddress.toString(),500);
       await this.redisInterface.removeFromRedisListToLimit("submitted_shares_list:"+minerEthAddress.toString(),500);
