...
module.exports =  {
   ...
   */
   ...
   async awardShareCredits( minerEthAddress, shareCredits )
   {
    ...
    if( minerData.shareCredits == null) minerData.shareCredits = 0
    if( shareCredits == null) shareCredits = 0

    console.log( 'miner data ',  minerData.shareCredits)

    console.log( 'miner data ',shareCredits)
