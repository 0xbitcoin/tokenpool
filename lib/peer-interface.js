...
/*
  ...
  async update()
  {
    ...
    setInterval(function(){this.processQueuedShares()}.bind(this),4000)
    ...
    setInterval(function(){PeerInterface.calculateMinerHashrateData()}.bind(this), 4000)
  ...
  async processQueuedShares(mongoInterface)
  {
    ...
    var shareData  = await mongoInterface.findAndDeleteOne('queued_shares_list')  //this.redisInterface.popFromRedisList("queued_shares_list")
