     ...
     for(i in payment_txes)
     {
      ...
      if(txDataJSON == null || (txData.last_broadcast_block < (currentEthBlock - REBROADCAST_WAIT_BLOCKS)) )
      {
        ...
        var broadcastedPaymentData = {
             ...
             ethMinerAddress: paymentData.minerAddress,
             amount:paymentData.previousTokenBalance,
        ...
        var transferData = JSON.parse(txDataJSON)

        if(balanceTransferJSON == null || transferData.txHash == null)
        {

          var transferData = {
            addressTo: paymentData.minerAddress,
            balancePaymentId: paymentId,
            tokenAmount: paymentData.previousTokenBalance,
            txHash: null,
        ...
        }else if(transferData.confirmed != true)
        {
