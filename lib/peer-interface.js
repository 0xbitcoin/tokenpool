...
module.exports =  {
  ...
  async update()
  {
    ...
    //Error
     ...
     setTimeout(function(){self.calculateMinerHashrateData()},0)
   ...
   async calculateMinerHashrateData()
   {
     ...
     var self = this ;
        ...
        //  setTimeout(function(){self.calculateMinerHashrateData()},4000  )///perform after booting
         setTimeout(function(){self.calculateMinerHashrateData()},UPDATE_VAR_DIFF_PERIOD  )  // 1 minute
   },
        ...
        submitShare: async function(args, callback) {
          ...
          callback(null,  validJSONSubmit );
           ...
           getMinerData: async function(args, callback) {
             ...
             minerData.miningDifficulty = minDiff
