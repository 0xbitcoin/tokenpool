...
*/
  ...
  async  getShareCreditsFromDifficulty(difficulty,shareIsASolution)
   ...
   async awardShareCredits( minerEthAddress, shareCredits )
   {
    ...
    var sharesData = await this.loadSharesDataFromMongo(minerEthAddress)
   ...
   async getSharesData(minerEthAddress)
   {
     if(minerEthAddress)
     {
       var minerDataJSON = await this.mongoInterface.findOne("shares_data_downcase", minerEthAddress.toString().toLowerCase() );
   ...
   async loadMinerDataFromMongo(minerEthAddress)
   {
     if(minerEthAddress == null) return null;
      ...
      var existingMinerDataJSON = await this.mongoInterface.findOne("miner_data_downcase", minerEthAddress.toString().toLowerCase() );
   ...
   async getMinerData(minerEthAddress)
   {
     if(minerEthAddress)
     {
       var minerDataJSON = await this.mongoInterface.findOne("miner_data_downcase", minerEthAddress.toString().toLowerCase() );

       if(minerDataJSON == null)
       {
         return this.getDefaultSharesData(minerEthAddress)
       }
