   ...
   estimateMinerHashrate(minerData, period)
   {
     ...
     if(minerValidSubmittedSolutions >= 1){
       ...
       try {
          ...
          console.log( web3utils.toBN(minerVarDiff) )
          console.log( web3utils.toBN(minerVarDiff).mul( web3utils.toBN(2) ) )
          console.log( web3utils.toBN(minerVarDiff).mul( web3utils.toBN(2).pow(  web3utils.toBN(22)  ) ) )
