   ...
   //required for balance payouts
      ...
      async storeNewSubmittedTransferData(txHash, addressTo, balancePaymentId, tokenAmount)
      {
            ...
            var balanceTransferData = {
              ...
              console.log('Storing new submitted transfer data',balanceTransferData)

            //helps audit payouts
          await this.redisInterface.pushToRedisList(('balance_transfers'+minerAddress.toString()), JSON.stringify(balanceTransferData)  )
