...
module.exports =  {
  ...
  async init(web3,tokenContract,poolConfig,accountConfig,redisInterface,mongoInterface,tokenInterface)
  {
    this.web3=web3;
  ...
  */
  ...
  async monitorMinedPayments()
  {
   ...
   console.log('error',e)
     ...
     setTimeout(function(){self.monitorMinedPayments()},30*1000)
  ...
  */
     async batchMinedPayments(unbatched_pmnts )
     {
       var self = this ;
      ...
      if( unbatched_pmnts.length >= 5)
      {

        newBatchId = web3utils.randomHex(32)

        var paymentsToBatch = unbatched_pmnts.slice(0,50)



        paymentsToBatch.forEach(async function(element){

          element.batchId = newBatchId;

          console.log('batching ',element)
