...
module.exports =  {
  ...
  async init(web3, pool_env,  redisInterface,mongoInterface, web3apiinterface )
  {
  ...
  //  this.mintHelperContract = mintHelperContract;
    ...
    TransactionHelper.init(web3,pool_env,redisInterface,mongoInterface, web3apiinterface);
