...
export default class TransactionCoordinator  {
  ...
  async update()
  {
            ...
            setTimeout(function(){this.monitorMinedPayments(this.mongoInterface, this.poolConfig)}.bind(this),0)

            setTimeout(function(){TransactionHelper.broadcastPaymentBatches(this.mongoInterface)}.bind(this),0)
  } 
  ...
  */
    ...
    async monitorMinedPayments(mongoInterface, poolConfig)
  {
     ...
     setTimeout(function(){TransactionCoordinator.monitorMinedPayments(mongoInterface, poolConfig)}.bind(this),30*1000)  //30 seconds
