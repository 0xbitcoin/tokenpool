...
//        console.log('transactionPacketsData',transactionPacketsData)
        ...
        //  console.log('item',item)
          ...
          this.redisInterface.storeRedisData('pendingMintsCount',pendingMintsCount);
          this.redisInterface.storeRedisData('pendingPaymentsCount',pendingPaymentsCount);
   ...
   //required for balance payouts
     ...
     async transferTokensFromPool(ethMinerAddress, amount, balancePaymentId, resending)
     {
          ...
          var broadcastedPaymentData = {
             ...
             confirmed: false //confirmed by the ethereum network
          }
          ...
          await this.redisInterface.pushToRedisList(('broadcasted_payments'), JSON.stringify({ethMinerAddress: ethMinerAddress.toString(),balancePaymentId: balancePaymentId.toString()})  )
          await this.redisInterface.pushToRedisList(('unconfirmed_broadcasted_payments'), JSON.stringify({ethMinerAddress: ethMinerAddress.toString(),balancePaymentId: balancePaymentId.toString()})  )
