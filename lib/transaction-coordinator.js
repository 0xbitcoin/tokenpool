  ...
  async broadcastQueuedMintTransactions(){
   ...
   async broadcastQueuedPaymentTransactions(){
     ...
     var hasQueuedTransaction = (transactionStats.queuedCount > 0)
        ...
        setTimeout(function(){self.broadcastQueuedPaymentTransactions()},10 * 1000)
...
//        console.log('transactionPacketsData',transactionPacketsData)
        ...
        //  console.log('item',item)
          ...
          await this.redisInterface.storeRedisData('queuedMintsTxCount',queuedMintsCount);
          await this.redisInterface.storeRedisData('queuedPaymentsTxCount',queuedPaymentsCount);
