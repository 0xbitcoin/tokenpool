...
export default class TransactionCoordinator  {
  ...
  async update()
  {
          ...
          var self=this;
            ...
            setTimeout(function(){this.broadcastQueuedMintTransactions()}.bind(this),0)

            setTimeout(function(){this.updateBroadcastedTransactionStatus()}.bind(this),0)

            setTimeout(function(){this.monitorMinedPayments()}.bind(this),0)

            setTimeout(function(){TransactionHelper.broadcastPaymentBatches()}.bind(this),0)
  },
  ...
  */
  ...
  async monitorMinedPayments()
  {
     ...
     setTimeout(function(){this.monitorMinedPayments()}.bind(this),30*1000)  //30 seconds
  ...
  //refactor and test -- use mongo 
   async updateBroadcastedTransactionStatus(   )
   {
     ...
     }catch(e)
     {
      ...
      setTimeout(function(){this.updateBroadcastedTransactionStatus()}.bind(this),2000)
   } 
