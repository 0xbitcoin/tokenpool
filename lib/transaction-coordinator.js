...
module.exports =  {
  ...
  //  this.mintHelperContract = mintHelperContract;
    ...
    TransactionHelper.init(web3,pool_env, accountConfig,redisInterface,mongoInterface);
...
//types are 'transfer','solution'
  ...
  async broadcastQueuedMintTransactions(){
   ...
   if(txType=="solution"){
          ...
          var tx_hash = await TransactionHelper.submitMiningSolutionUsingMiningKing(txData.minerEthAddress,txData.solution_number,txData.challenge_digest,txData.challenge_number)
