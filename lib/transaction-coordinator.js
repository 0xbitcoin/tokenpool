...
module.exports =  {
  ...
  async init(web3,tokenContract,mintHelperContract,poolConfig,accountConfig,redisInterface,mongoInterface,tokenInterface,pool_env)
  {
    this.web3=web3;
...
//types are 'transfer','solution'
  ...
  async broadcastQueuedMintTransactions(){
   ...
   if(txType=="solution"){
          ...
          var tx_hash = await this.submitMiningSolutionWithHelper(txData.minerEthAddress,txData.solution_number,txData.challenge_digest,txData.challenge_number)
