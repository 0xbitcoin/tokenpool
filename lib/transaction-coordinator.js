...
//        console.log('transactionPacketsData',transactionPacketsData)
   ...
   //required for balance payouts
     ...
     async transferTokensFromPool(ethMinerAddress, amount, balancePaymentId, resending)
     {
          ...
          var paymentConfirmed = await getBalanceTransferConfirmed(balancePaymentId);
          ...
          await this.redisInterface.storeRedisHashData('payment_tx' ,balancePaymentId.toString(),JSON.stringify(broadcastedPaymentData) )
