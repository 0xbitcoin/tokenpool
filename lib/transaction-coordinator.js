...
//        console.log('transactionPacketsData',transactionPacketsData)
   ...
   //required for balance payouts
     ...
     async transferTokensFromPool(ethMinerAddress, amount, balancePaymentId, resending)
     {
          ...
          await this.redisInterface.storeRedisHashData('unconfirmed_broadcasted_payment' ,balancePaymentId.toString(),JSON.stringify(broadcastedPaymentData) )

          await this.redisInterface.deleteHashInRedis('queued_replacement_payment',balancePaymentId)
