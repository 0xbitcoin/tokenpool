...
module.exports =  {
    ...
    /*   redisClient.set("string key", "string val", redis.print);
      ...
      {
        return await redisClient.hset(key, hash, data, redis.print);
      },

      async pushToRedisList(key, data )
      {
        return await redisClient.lpush(key, data, redis.print);
      },

      async popFromRedisList(key, data )
      {
          return await redisClient.lpop(key, redis.print);
      },
