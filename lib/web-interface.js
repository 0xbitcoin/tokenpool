...
module.exports =  {
  ...
  async init( web3, accountConfig, poolConfig , redisInterface ,testmode  )
  {
    ...
    {
        var sharesList = await this.redisInterface.getParsedElementsOfListInRedis(('miner_submitted_share:'+minerAddress.toString()), limitAmount)
   ...
   {
       var sharesList = await this.redisInterface.getParsedElementsOfListInRedis(('miner_invalid_share:'+minerAddress.toString()), limitAmount)
